...
class RekamMedisViewScreen extends StatefulWidget {
  ...
  @override
  State<RekamMedisViewScreen> createState() => _RekamMedisViewScreenState();
}

class _RekamMedisViewScreenState extends State<RekamMedisViewScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          // Tombol Unduh PDF di AppBar — read only, tidak ada tombol edit
          IconButton(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Tombol besar unduh PDF hijau di bawah
              SizedBox(
